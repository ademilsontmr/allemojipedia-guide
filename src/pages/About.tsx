...
const About = () => {
  return (
    <Layout>
      <Helmet>
        <title>About Us - All Emojipedia</title>
        <meta
          name="description"
          content="Learn about All Emojipedia - your comprehensive emoji reference guide. Discover why we created this project and our mission to help everyone communicate better with emojis."
        />
      </Helmet>
