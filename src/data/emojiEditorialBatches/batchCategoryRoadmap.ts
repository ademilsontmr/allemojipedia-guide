...
export const categoryEditorialRoadmap: CategoryEditorialStatus[] = [
  ...
  },
  {
    ...
    thinRemaining: 0,
    status: "complete",
    batchFile: "batch10 + batch13 + batch18 + batch19 + batch37-travel-clocks-moon-astro.ts",
    notes: "114/114 thin manual — clocks, moon phases, and sky complete in batch 37.",
  },
  {
    slug: "objects",
    name: "Objects",
  ...
  },
  {
    ...
    thinRemaining: 0,
    status: "complete",
    batchFile: "batch35-symbols-complete.ts",
    notes: "132/132 thin manual — signage, arrows, AV, keycaps, warnings. Category complete.",
  },
  {
    slug: "flags",
    name: "Flags",
    ...
    thinRemaining: 0,
    status: "complete",
    batchFile: "batch36-flags-complete.ts",
    notes: "126/126 thin manual — country travel, sports, diaspora context. Category complete.",
  },
];
