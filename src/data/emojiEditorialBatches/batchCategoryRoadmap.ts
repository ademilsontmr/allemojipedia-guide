...
export const categoryEditorialRoadmap: CategoryEditorialStatus[] = [
  ...
  },
  {
    ...
    thinRemaining: 77,
    status: "in-progress",
    batchFile: "batch10-top-smileys-travel.ts + batch13-top-travel-objects.ts",
    notes: "30 manual travel pages (batches 10 + 13 P0/P1); P2 queue in batch13-priority.ts.",
  },
  {
    slug: "objects",
    name: "Objects",
    ...
    thinRemaining: 123,
    status: "in-progress",
    batchFile: "batch13-top-travel-objects.ts",
    notes: "17 manual object pages in batch 13 (P0 + P1); P2 queue in batch13-priority.ts.",
  },
  {
    slug: "activities",
    name: "Activities",
