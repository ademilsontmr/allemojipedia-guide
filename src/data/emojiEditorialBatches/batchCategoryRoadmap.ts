...
export const categoryEditorialRoadmap: CategoryEditorialStatus[] = [
  ...
  },
  {
    ...
    notes: "15 manual travel pages (batches 10 + 13 P0); P1 queue in batch13-priority.ts.",
  },
  {
    slug: "objects",
    name: "Objects",
    ...
    notes: "7 P0 object pages manual in batch 13; P1/P2 queue in batch13-priority.ts.",
  },
  {
    slug: "activities",
    name: "Activities",
