...
export const editorialBatchRegistry: EditorialBatchMeta[] = [
  ...
  {
    id: "44-p1-wave4-faces-extend",
    name: "P1 Wave 4 — faces-extend exclusivity",
    category: "smileys-and-emotion",
    emojiCount: 15,
    status: "complete",
    notes:
      "Hand-written exclusivity for anxious vs fearful, disappointed vs pensive/cry, weary vs tired, yawn vs sleep vs sleepy, dizzy vs exploding head, cold vs hot, nauseated vs vomiting, sneeze vs thermometer.",
  },
  {
    id: "45-p1-wave5-faces-extend",
    name: "P1 Wave 5 — faces-extend exclusivity",
    category: "smileys-and-emotion",
    emojiCount: 15,
    status: "complete",
    notes:
      "Hand-written exclusivity for bandage injury, cowboy irony, lying face, angry vs pouting vs symbols, smiling vs angry horns, ogre vs goblin, robot vs alien monster, skull-and-crossbones vs skull, jack-o-lantern, mouth/lips slang.",
  },
  {
    id: "46-p1-wave6-top-close",
    name: "P1 Wave 6 — close remaining topEmojiSlugs",
    category: "smileys-and-emotion",
    emojiCount: 28,
    status: "complete",
    notes:
      "Remaining hearts + hand/gesture pages — closes exclusivity coverage for topEmojiSlugs.",
  },
  {
    id: "47-indexing-stier-gsc",
    name: "Indexing S-tier — GSC crawled-not-indexed priorities",
    category: "smileys-and-emotion",
    emojiCount: 3,
    status: "complete",
    notes:
      "Hand rewrite for ❤️ 💀 🥺 — pages listed in Search Console as crawled but not indexed.",
  },
  {
    id: "48-indexing-stier-wave2",
    name: "Indexing S-tier wave 2 — laugh, fire, cry, sparkles",
    category: "smileys-and-emotion",
    emojiCount: 4,
    status: "complete",
    notes: "Hand rewrite for 😂 🔥 😭 ✨ — next home-hub priorities after wave 1.",
  },
  {
    id: "49-indexing-stier-wave3",
    name: "Indexing S-tier wave 3 — heart eyes, thinking, thumbs, prayer, 100",
    category: "smileys-and-emotion",
    emojiCount: 5,
    status: "complete",
    notes: "Hand rewrite for 😍 🤔 👍 🙏 💯 — third home-hub ring.",
  },
];
